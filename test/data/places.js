...
export const newyork = new LatLng(40.71417, -74.00639);
export const sydney = new LatLng(-33.873651, 151.20689);
export const moscow = new LatLng(55.7522222, 37.6155556);
export const buenosaires = new LatLng(-34.608418, -58.373161);
export const path = [
